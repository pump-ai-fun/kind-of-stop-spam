...
namespace kind_of_stop_spam
{
    ...
    public sealed class HtmlFileChatView : IDisposable
    {
        ...
        private void WriteHtmlLocked()
        {
            ...
            sb.Append("  .content{margin-top:6px; white-space:pre-wrap; word-wrap:break-word; overflow-wrap:anywhere; word-break:break-word;}\n");
            ...
            sb.Append("  .reply .reply-label{color:#8ab4f8; font-weight:600; margin-right:4px;}\n");
            sb.Append("  .msg{transition: background-color .2s ease;}\n");
            sb.Append("</style>\n</head>\n");
            ...
            foreach (var m in _messages)
            {
                ...
                var bgStyle = !string.IsNullOrWhiteSpace(m.HighlightColor) ? $" style=\"background:{HtmlEncode($"#{m.HighlightColor!}")};\"" : string.Empty;
                sb.Append("  <li class=\"msg\"" + bgStyle + ">\n");
